...
void
ResourceRequestPrivate::setHTTPMethod(const String& method)
{
    ((WebCore::ResourceRequest&)m_webcore).setHTTPMethod(method);
}
...
#ifdef WKC_ADD_WKC_HELPERS
void
ResourceRequest::setHTTPMethod(const String& method)
{
    m_private.setHTTPMethod(method);
}
#endif // WKC_ADD_WKC_HELPERS
