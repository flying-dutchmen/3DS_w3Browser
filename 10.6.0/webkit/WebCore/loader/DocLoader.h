...
#if 1
    // webkit.org trunk r92143
    void collectGarbageDocumentResourcesSoon();
#endif
...
#if 1
    // webkit.org trunk r92143
    void garbageCollectDocumentResourcesTimerFired(Timer<DocLoader>*);
#endif
...
#if 1
    // webkit.org trunk r92143
    Timer<DocLoader> m_garbageCollectDocumentResourcesTimer;
#endif
