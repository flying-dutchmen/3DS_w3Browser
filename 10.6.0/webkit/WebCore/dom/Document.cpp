...
#ifdef WKC_IMPROVE_HISTORY_API_CONFORMANCE
    // webkit.org trunk r66841
...
// webkit.org trunk r66841
#if PLATFORM(WKC)
static String* gLoading = 0;
static String* gInteractive = 0;
static String* gComplete = 0;
#endif
#endif
...
#if PLATFORM(WKC)
    if (!gLoading) {
        gLoading = new String("loading");
    }
    const String& loading = *gLoading;
    if (!gInteractive) {
        gInteractive = new String("interactive");
    }
    const String& interactive = *gInteractive;
    if (!gComplete) {
        gComplete = new String("complete");
    }
    const String& complete = *gComplete;
#else
...
#if 1
    // partial merge of webkit.org trunk r60608
