...
DocLoader::DocLoader(Document* doc)
    ...
    , m_requestCount(0)
#if 1
    // webkit.org trunk r92143
    , m_garbageCollectDocumentResourcesTimer(this, &DocLoader::garbageCollectDocumentResourcesTimerFired)
#endif
...
#if 1
    // webkit.org trunk r87485
    if (!protocolIs(fullURL.string(), "data"))
...
#if 1
// webkit.org trunk r92143
void DocLoader::collectGarbageDocumentResourcesSoon()
{
...
void DocLoader::garbageCollectDocumentResourcesTimerFired(Timer<DocLoader>* timer)
{
